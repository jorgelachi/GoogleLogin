...
$apiConfig = array(
    ...
    'application_name' => 'Ourlimm',

    // OAuth2 Settings, you can get these keys at https://code.google.com/apis/console
    'oauth2_client_id' => 'Aquí coloca tu ID Client Google',
    'oauth2_client_secret' => 'Aquí coloca tu ID Client Secret Google',
    'oauth2_redirect_uri' => 'Aquí coloca la página de redireccionamiento,preferencia el index.php',
